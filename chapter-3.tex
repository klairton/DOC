...
Existe um algoritmo de aproximação com fator $3-k$ para o problema \SbPRT{} em instâncias clássicas sem sinais e para $k \in [0..1]$.
\end{theorem}
\begin{proof}
