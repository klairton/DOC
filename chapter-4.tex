...
Note que caso a heurística forneça alguma operação, então sabemos que pelo menos dois breakpoints tipo um de $\mathcal{I}$ são removidos. Logo, a utilização da heurística pelos algoritmos indicados não altera o fator de aproximação teórico garantido pelos mesmos.
...
Note que as funções $\mathcal{F}$ e $\mathcal{G}$ podem ser computadas em tempo linear. A seguir, apresentamos o Algoritmo~\ref{algorithm:UJBJJGGJ}, que fornece uma estrutura base para o desenvolvimento de algoritmos para as variações com sinais dos problemas $\SbIR{}$, $\SbIRI{}$, $\SbIRM{}$, $\SbIRMI{}$, $\SbIRT{}$, $\SbIRTI{}$, $\SbIRTM{}$ e $\SbIRTMI{}$.

\input{algorithms/UJBJJGGJ}

Note que o tempo de execução do Algoritmo~\ref{algorithm:UJBJJGGJ} será igual ao tempo de execução do algoritmo $\mathcal{A}$, uma vez que para ler os dados de entrada é necessário um tempo linear e as funções $\mathcal{F}$ e $\mathcal{G}$ executam também em tempo linear.

% ------------------------------------------------------------------ %
\subsection{Reversão}
% ------------------------------------------------------------------ %

Nesta seção, com base na estrutura do Algoritmo~\ref{algorithm:UJBJJGGJ}, apresentaremos um algoritmo de aproximação com fator $4$ para a variação com sinais do problema \SbIR{}.

\begin{theorem}\label{theorem:DGTASCUU}
Dada uma instância intergênica rígida balanceada com sinais $\mathcal{I}=((\pi,\breve\pi),(\iota,\breve\iota))$, o Algoritmo~\ref{algorithm:UJBJJGGJ} é uma $4$-aproximação para o problema \SbIR{} adotando $\mathcal{A}=$Algoritmo~\ref{algorithm:AKKUXQNR}.
\end{theorem}
\begin{proof}
...
Nesta seção, com base na estrutura do Algoritmo~\ref{algorithm:UJBJJGGJ}, apresentaremos um algoritmo de aproximação com fator $4$ para a variação com sinais do problema \SbIRI{}.

\begin{theorem}\label{theorem:CLXFCZMR}
Dada uma instância intergênica rígida com sinais $\mathcal{I}=((\pi,\breve\pi),(\iota,\breve\iota))$, o Algoritmo~\ref{algorithm:UJBJJGGJ} é uma $4$-aproximação para o problema \SbIRI{} adotando $\mathcal{A}=$Algoritmo~\ref{algorithm:LHOPSFVN}.
\end{theorem}
\begin{proof}
...
Nesta seção apresentaremos algoritmos de aproximação com fatores de aproximação $4$ e $2$ para a variação com sinais do problema \SbIRM{}.

\begin{theorem}\label{theorem:KJSCUFTB}
Dada uma instância intergênica rígida balanceada com sinais $\mathcal{I}=((\pi,\breve\pi),(\iota,\breve\iota))$, o Algoritmo~\ref{algorithm:UJBJJGGJ} é uma $4$-aproximação para o problema \SbIRM{} adotando $\mathcal{A}=$Algoritmo~\ref{algorithm:OLSRUEFZ}.
\end{theorem}
\begin{proof}
...
Nesta seção apresentaremos algoritmos de aproximação com fatores de aproximação $4$ e $2$ para a variação com sinais do problema \SbIRMI{}.

\begin{theorem}\label{theorem:PZXMHZFE}
Dada uma instância intergênica rígida com sinais $\mathcal{I}=((\pi,\breve\pi),(\iota,\breve\iota))$, o Algoritmo~\ref{algorithm:UJBJJGGJ} é uma $4$-aproximação para o problema \SbIRMI{} adotando $\mathcal{A}=$Algoritmo~\ref{algorithm:JAJGNYWD}.
\end{theorem}
\begin{proof}
...
Nesta seção, com base na estrutura do Algoritmo~\ref{algorithm:UJBJJGGJ}, apresentaremos um algoritmo de aproximação com fator $4$ para a variação com sinais do problema \SbIRT{}.

\begin{theorem}\label{theorem:TRRZCTJT}
Dada uma instância intergênica rígida balanceada com sinais $\mathcal{I}=((\pi,\breve\pi),(\iota,\breve\iota))$, o Algoritmo~\ref{algorithm:UJBJJGGJ} é uma $4$-aproximação para o problema \SbIRT{} adotando $\mathcal{A}=$Algoritmo~\ref{algorithm:LCPCUFNZ}.
\end{theorem}
\begin{proof}
...
Nesta seção, com base na estrutura do Algoritmo~\ref{algorithm:UJBJJGGJ}, apresentaremos um algoritmo de aproximação com fator $4$ para a variação com sinais do problema \SbIRTI{}.

\begin{theorem}\label{theorem:PTXWEJRJ}
Dada uma instância intergênica rígida com sinais $\mathcal{I}=((\pi,\breve\pi),(\iota,\breve\iota))$, o Algoritmo~\ref{algorithm:UJBJJGGJ} é uma $4$-aproximação para o problema \SbIRTI{} adotando $\mathcal{A}=$Algoritmo~\ref{algorithm:YIZYUGZZ}.
\end{theorem}
\begin{proof}
...
Nesta seção, com base na estrutura do Algoritmo~\ref{algorithm:UJBJJGGJ}, apresentaremos um algoritmo de aproximação com fator $3$ para a variação com sinais do problema \SbIRTM{}.

\begin{theorem}\label{theorem:SIMBVUPO}
Dada uma instância intergênica rígida balanceada com sinais $\mathcal{I}=((\pi,\breve\pi),(\iota,\breve\iota))$, o Algoritmo~\ref{algorithm:UJBJJGGJ} é uma $3$-aproximação para o problema \SbIRTM{} adotando $\mathcal{A}=$Algoritmo~\ref{algorithm:UZWADMNZ}.
\end{theorem}
\begin{proof}
...
Nesta seção, com base na estrutura do Algoritmo~\ref{algorithm:UJBJJGGJ}, apresentaremos um algoritmo de aproximação com fator $3$ para a variação com sinais do problema \SbIRTMI{}.

\begin{theorem}\label{theorem:KKKBVPAY}
Dada uma instância intergênica rígida com sinais $\mathcal{I}=((\pi,\breve\pi),(\iota,\breve\iota))$, o Algoritmo~\ref{algorithm:UJBJJGGJ} é uma $3$-aproximação para o problema \SbIRTMI{} adotando \break$\mathcal{A}=$Algoritmo~\ref{algorithm:FMDPGQTJ}.
\end{theorem}
\begin{proof}
