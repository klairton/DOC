...
Nesta seção iremos apresentar um algoritmo de aproximação com um fator de aproximação $2$ para a variação com sinais do problema \SbIRM{} baseado na estrutura de grafo de ciclos ponderado rígido.
...
Nesta seção iremos apresentar um algoritmo de aproximação com um fator de aproximação $2$ para a variação com sinais do problema \SbIRMI{} baseado na estrutura de grafo de ciclos ponderado rígido.
