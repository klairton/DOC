...
\begin{lemma}\label{lemma:IWIAXMBS}[Lema 5 de Oliveira \textit{et al.}~\cite{2021b-oliveira-etal}]
...
\begin{lemma}\label{lemma:ZLLUMKJN}[Lema 6 de Oliveira \textit{et al.}~\cite{2021b-oliveira-etal}]
