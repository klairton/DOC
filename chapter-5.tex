...
Para todas as variações dos problemas investigados neste capítulo, nós apresentamos algoritmos de aproximação com um fator constante com base em um processo de redução que permite o uso de resultados que foram apresentados para as respectivas versões rígidas dos problemas. Apesar dos problemas flexíveis investigados neste capítulo serem uma generalização dos problemas rígidos, do ponto de vista teórico, foi possível apresentar resultados equiparáveis as versões rígidas. 

% Por fim, realizamos testes experimentais para verificar o desempenho prático dos algoritmos que foram apresentados.