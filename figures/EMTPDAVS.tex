...
\caption[Possibilidades de remoção de pelo menos um breakpoint tipo um a partir de pares de breakpoints conectados.]{As possibilidades que podem surgir quando existe um par de breakpoints conectados e as reversões que podem ser aplicadas para remover pelo menos um breakpoint tipo um. O par de elementos que são consecutivos no genoma alvo é representado com uma cor em tons de cinza.}
